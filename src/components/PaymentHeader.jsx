export const PaymentHeader = () => {
    return <div className="flex justify-between items-center sm:gap-4 gap-2 sm:px-8 px-4 py-3 borber-b border-[#D9D9D9D9] sticky top-0 bg-[#fffff]">
        ...
        <div className="flex gap-2 justify-end sm:flex-grow">
            <button className="text-[#545353] bg-[#ffffff] shadow-md rounded-full p-2 sm:flex w-8 sm:w-10 sm:h-10 items-center justify-center">
            ...
            <button class="text-[#4D4D4D] bg-[#ffffff] shadow-md rounded-full p-1 sm:w-10 sm:h-10 flex items-center justify-center">
