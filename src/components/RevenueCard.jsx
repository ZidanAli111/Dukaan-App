export const RevenueCard = ({
    ...
    return <div className="flex-grow bg-white p-5  flex flex-col gap-4 rounded-[8px] shadow-md h-fit min-w-[300px] ">
        <h5 className="flex gap-3 items-center text-strokeWidth[#4D4D4D]">
            {title}
        ...
        <div className="flex justify-between  items-center  ">
            ...
            {orderCount ? <p className="flex  items-center  font-medium text-base underline text-[#146EB4]">
                {orderCount} Orders
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke="#2d73a4" className="size-6">
