...
const radialGaugeOptions = {
    ...
    colors: ['#00E396'], // Color for the radial gauge
    series: [70], // Example data
    labels: ['Humidity'],
    fill: {
        type: 'solid'
    },
    ...
    yaxis: {
        labels: {
            show: true, // Show y-axis labels
            formatter: (value) => `${value}%`, // Format y-axis labels
        }
    }
};
...
const RadialGauge = ({ options, series }) => (
    <div className="bg-white p-4 shadow-sm flex-1">
        <ApexCharts
            options={options}
            series={series}
...
export const Statistics = () => {
    ...
    var gauge = echarts.init(gaugeId);
    var gaugeOption = {
        series: [{
            type: 'gauge',
            detail: { formatter: '{value}%', fontSize: 20 },
            data: [{ value: 46, name: 'Humidity' }],
            ...
            <div id="parent-main-body-container" className="flex flex-col lg:flex-row gap-4 p-4 bg-gray-200">
                ...
                <div id="left-grid" className="flex flex-col space-y-4 lg:w-[30%]">
                    ...
                    <div id="channels-container" className="bg-gray-200 border-none px-4 shadow-sm flex-1">
                        <div id="channels-list" className="flex flex-col bg-gray-200">
